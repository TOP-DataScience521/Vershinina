...
# интервала - потенциальные выбросы. Я отбросила значения от 20 и больше. По такому же принципу я поступила с переменной LSTAT 
# маска для фильтрации значений
mask = (data['MEDV'] != 50) &  (data['CRIM'] <= 20) & (data['LSTAT'] <= 35)
